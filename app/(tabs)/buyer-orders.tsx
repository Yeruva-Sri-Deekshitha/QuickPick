...
import { Package, Calendar, CircleCheck as CheckCircle, Circle as XCircle, Clock } from 'lucide-react-native';
...
export default function BuyerOrdersScreen() {
  ...
  const handleMarkAsCollected = async (orderId: string) => {
    try {
      const response = await OrderService.updateOrderStatus(orderId, 'collected');
        ...
        <View style={styles.orderFooter}>
          ...
          {item.status === 'reserved' && (
            <Button
              ...
              onPress={() => handleMarkAsCollected(item.id)}
              size="small"
              variant="secondary"
            />
          )}
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyText}>
        Start discovering and reserving deals to see your orders here!
      </Text>
    </View>
  );
